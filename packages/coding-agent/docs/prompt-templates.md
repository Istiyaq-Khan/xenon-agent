> Xenon Agent can create prompt templates. Ask it to build one for your workflow.
...
Xenon Agent loads prompt templates from:

- Global: `~/.xenon-agent/prompts/*.md`
- Project: `.xenon-agent/prompts/*.md`
