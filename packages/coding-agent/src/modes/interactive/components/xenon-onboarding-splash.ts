...
export interface XenonOnboardingSplashOptions {
	getRows?: () => number;
	requestRender?: () => void;
	animationIntervalMs?: number;
	continueActionLabel?: string;
}
const LOGO_LINES = XENON_BUTTERFLY_LOGO.split("\n");
...
export class XenonOnboardingSplashComponent implements Component {
	private frame = 0;
	...
	constructor(
		...
		private readonly options: XenonOnboardingSplashOptions = {},
	) {
	...
	private formatBrandLine(): PanelTextLine {
		return [
			...
			{ text: "XENON", tone: "text", bold: true },
