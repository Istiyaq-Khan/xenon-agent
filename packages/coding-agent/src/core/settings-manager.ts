...
export interface Settings {
	...
	bundledSkills?: BundledSkillsSettings; // Configure built-in skills shipped with Xenon Agent
	enableBuiltinSkills?: boolean; // default: true - load built-in skills shipped with xenon-agent
